                                ...
                                data={[
                                    ...
                                    <div className="alert-table-action-button-container">
                                        {selectedPage === "Running" ?
                                            <Input type="button" value="Edit" style={{width: "90px"}} onClick={() => {
                                                setAddOrEditAlert('Edit');
                                                setCurrentAlert(alert)
                                            }} outlined/> :
                                            <Input type="button" value="Restore" style={{width: "90px"}}
                                                   onClick={() => call('restoreAlert', alert.alertId)} outlined/>
                                        }
                                        <Input type="button" value="Delete" style={{width: "90px"}} onClick={() => {
                                            setDeleteOrClearAlert('deleteAlert');
            ...
            <Modal open={addOrEditAlert} close={setAddOrEditAlert}>
                <div style={{width: "400px", WebkitUserSelect: "none", userSelect: "none"}}>
                    <div style={{width: "300px", margin: "auto", marginBottom: "25px"}}>
                        ...
                        <Input type="dropdown" label='Coin' options={options} value={currentAlert.coin}
                               onChange={setCoin}/>
                        <Input type="dropdown" label='Condition' value={currentAlert.condition} onChange={setCondition}
                        ...
                        <Input type="toggle" toggleLabel="Email Notification"
                               checked={currentAlert.emailActiveStatus || false} onChange={setEmail}/>

                        <div className="edit-alert-modal-button-container">
                            <Input type="button" style={{width: "110px"}} disabled={isInvalid[0]}
                                   onClick={() => call(addOrEditAlert)} value={addOrEditAlert}/>
                            <Input type="button" style={{width: "110px"}} onClick={() => setAddOrEditAlert(false)}
                                   value="Cancel" red/>
                        </div>
                ...
                <div style={{width: "350px"}}>
                    <div style={{width: "300px", margin: "0 auto 30px auto"}}>
                        ...
                        <p style={{
                            ...
                            marginTop: "10px",
                            color: "#9e9e9e"
                        }}>{deleteOrClearAlert === 'clearAll' ? 'Are you sure you want to clear all alerts?' : 'Are you sure you want to delete the alert?'}</p>
                        ...
                        <div className="edit-alert-modal-button-container" style={{width: '250px', marginTop: '30px'}}>
                            <Input type="button" style={{width: "110px"}} onClick={() => call(deleteOrClearAlert)}
                                   value={deleteOrClearAlert === 'clearAll' ? 'Clear All' : 'Delete'} red/>
                            <Input type="button" style={{width: "110px"}} onClick={() => setDeleteOrClearAlert(false)}
                                   value="Cancel"/>
                        </div>
                    </div>
                </div>
